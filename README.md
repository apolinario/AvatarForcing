# Avatar Forcing — real-time streaming

A fork of [TaekyungKi/AvatarForcing](https://github.com/TaekyungKi/AvatarForcing)
(*Avatar Forcing: Real-Time Interactive Head Avatar Generation for Natural
Conversation*, CVPR 2026 — Ki, Jang, Jo, Yoon, Hwang;
[paper](https://arxiv.org/abs/2601.00664v2) ·
[project page](https://taekyungki.github.io/AvatarForcing/)) that adds a
real-time conversational server around the released model.

The model, the checkpoints and the rollout are upstream's. What this fork adds
is everything below, plus three small environment fixes to upstream files
(listed under *Changes to upstream files*). Upstream's original README is kept
as [UPSTREAM.md](./UPSTREAM.md).
