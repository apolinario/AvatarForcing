...
# on disk before the engine reads them. They come from the Hub
# (AVATAR_WEIGHTS_REPO). Do not confuse with lycui/AvatarForcing — that is a
# different model (arXiv 2603.14331) with different checkpoints.
# --------------------------------------------------------------------------- #
